...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Assets',userId: userId),
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          FlatButton(
            child: Text('logout'),
            onPressed: (){
              Navigator.of(context).pushReplacementNamed('/login',arguments: 'home');
            },
          ),
        ],
      ),
              ...
              return AlertDialog(
                ...
                actions: <Widget>[  
                  ...
                  FlatButton(
                    child: Text('Delete'),
                    onPressed: ()async{
                      await Firestore.instance.collection('users').document(userId).collection('assets').document(asset.reference.documentID)
                      .delete();
