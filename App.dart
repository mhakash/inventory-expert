...
//   TextEditingController voteInput;

//   @override
//   void initState() {
//     nameInput = TextEditingController();
//     voteInput = TextEditingController();
//     super.initState();
//   }
...
//       onPressed: _itemInputAlert,
//     );
//   }

//   _itemInputAlert() async{
...
//               child: Text('add'),
//               onPressed: (){
//                 if(nameInput.text.isNotEmpty && voteInput.text.isNotEmpty){
//                   //Firestore.instance.collection('baby').add;
                  
//                   Firestore.instance.collection('baby')
//                     .add({"name": nameInput.text, "votes": int.parse(voteInput.text)})
//                     .then((result)=>{
